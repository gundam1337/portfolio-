  ...
  return (
    ...
    >
      <section className="bg-gray-100 max-w-[42rem] border border-black/5 rounded-lg overflow-hidden sm:pr-8 relative hover:bg-gray-200 transition sm:group-even:pl-8 dark:text-white dark:bg-white/10 dark:hover:bg-white/20">
        <div className="pt-4 pb-4 px-5 sm:pl-10 sm:pr-2 sm:pt-10 sm:max-w-[50%] flex flex-col items-start sm:group-even:ml-[18rem]">
          ...
          <button
            type="button"
            className="self-center text-white bg-gradient-to-br from-green-400 to-blue-600 hover:bg-gradient-to-bl 
               focus:ring-4 focus:outline-none focus:ring-green-200 dark:focus:ring-green-800 
               font-medium rounded-lg text-base px-4 py-2 text-center me-2 mb-2"
          >
            show me more
          </button>
